...
class SketchR2CNNTrain(object):
    ...
    def create_data_loaders(self, dataset_dict):
        data_loaders = {
            m: DataLoader(dataset_dict[m],
                          ...
                          num_workers=32 if m == 'train' else 16,
    ...
    def forward_batch(self, model, data_batch, mode, optimizer, criterion,  step_counter):
        is_train = mode == 'train'
        ...
        for epoch in range(1, num_epochs + 1):
            ...
            for mode in self.modes:
                ...
                for bid, data_batch in enumerate(data_loaders[mode]):
                    ...
                    logits, loss, gt_category = self.forward_batch(net, data_batch, mode, optimizer, criterion, self.step_counters[mode])
